...
namespace SPF.DBUtility
{
    public abstract class OleDBHelper
    {
        ...
        //public static string connectionString = string.Format("Provider=Microsoft.Jet.OLEDB.4.0;Persist Security Info=False;Data Source={0}", System.Web.HttpContext.Current.Server.MapPath(ConfigurationManager.ConnectionStrings["OleDB"].ConnectionString));
        public static string connectionString = string.Format("Provider=Microsoft.Jet.OLEDB.4.0;Persist Security Info=False;Data Source={0}", System.AppDomain.CurrentDomain.BaseDirectory + ConfigurationManager.ConnectionStrings["OleDB"].ConnectionString);
        #region 公用方法
